...
export default function NewConversation() {
    ...
    return (
        <ContentLayout
            header={
                <Header
                    description="Upload your audio file to be processed by AccionHealth"
        ...
        >
            <Container
                header={
                    <Header
                        variant="h3"
                        description="Note: AccionHealth offers additional features not built into this demo, such as Custom Vocabulary, Content Removal, and more. This is available via the AWS console, API, or SDK."
                    />
                }
            >
                                    ...
                                    <SpaceBetween direction="horizontal" size="xs">
                                        ...
                                        >
                                            <Popover
                                                ...
                                                content="The audio file will be submitted to AccionHealth after the recording is complete. Please position your device or microphone so it can capture all conversation participants."
                                            >
